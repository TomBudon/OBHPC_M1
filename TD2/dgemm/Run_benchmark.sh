...
versions=("IJK"  "IKJ"  "IEX"  "UNROLL4"  "UNROLL8"  "UNROLL16"  "CBLAS")
...
for compiler in ${compilers[*]}; do
     ...
     taskset -c 2 ./dgemm 100 10 > data/$compiler-O1.dat
     ...
     taskset -c 2 ./dgemm 100 10 > data/$compiler-O2.dat
     ...
     taskset -c 2 ./dgemm 100 10 > data/$compiler-O3.dat
